...
print(max_num(522,688,7.3))

#Comparison operators, checks if: == is equal, != not equal, > greater than, < less than, >= greater than or equal to, <= less """"
...
print(monthConversions.get("Jan")) # Has redundancy measures
print(monthConversions.get("Frt"))
print(monthConversions.get("Fey", "Not a valid key"))
#The key value doesn't have to be string.
